...
const collegeTeams = [
  ...
  team({
    ...
    arenaId: nodeId("arena", "conte-forum"),
    summary: "College flagship hub. Hockey East. James Hagens' committed_to edge still points here from the draft path.",
  }),
  team({
    ...
    arenaId: nodeId("arena", "agganis-arena"),
  }),
  team({
  ...
  team({
    ...
    arenaId: nodeId("arena", "magness-arena"),
  }),
  team({
    ...
    arenaId: nodeId("arena", "mt-bank-arena"),
  }),
  team({
    ...
    coverage: "deep",
    division: "NCHC",
    arenaId: nodeId("arena", "ralph-engelstad-arena"),
    summary: "College flagship hub. Ralph Engelstad Arena and the NCHC pipeline on the same graph as NHL rights.",
  }),
  team({
    ...
    coverage: "deep",
    division: "Big Ten",
    arenaId: nodeId("arena", "la-bahn-arena"),
    summary: "College flagship hub. Big Ten program — same Team type as Michigan, not a sidecar blog.",
  }),
  team({
